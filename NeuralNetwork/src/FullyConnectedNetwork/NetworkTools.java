...
public class NetworkTools {
    ...
    public static double[][] createRandomMultiArray(int sizeX, int sizeY, double min, double max){
        if(sizeX < 1 && sizeY < 1){
            return null;
        }
    ...
    public static double[][] createRandomMultiArray(int sizeX, int sizeY, double lower_bound, double upper_bound){
        if(sizeX < 1 || sizeY < 1){
            return null;
        }
        double[][] ar = new double[sizeX][sizeY];
